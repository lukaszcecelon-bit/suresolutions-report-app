  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // index.es (canvg), purify.es (dompurify) i html2canvas to OPCJONALNE
        // dynamiczne zależności jspdf (SVG-w-PDF, .html()) — nasz kod nigdy ich
        // nie woła (PDF jest teraz natywnym tekstem). Bez wykluczenia Workbox
